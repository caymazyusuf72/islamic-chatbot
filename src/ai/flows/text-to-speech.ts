...
const TextToSpeechOutputSchema = z.object({
  audioDataUri: z
    .string()
    .describe('The generated audio as a WAV data URI.'),
});
  ...
  async ({ text }) => {
    const { media } = await ai.generate({
      ...
      config: {
        ...
        speechConfig: {
          voiceConfig: {
            // Using a generic voice, which should support Turkish.
            // For specific languages, a different voice might be needed.
